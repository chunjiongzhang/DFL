...
class LocalModel(object):
    ...
    def train_one_round(self,p,round):
        ...
        print('\033[1;35;0m svhn1 p= \033[0m', p)
...
class FederatedClient(object):
    ...
    def register_handles(self):
        ...
        def on_request_update(*args):
            ...
            my_weights, train_loss, train_accuracy = self.local_model.train_one_round(req['p2'],req['round_number'])

            resp = {
                'round_number': req['round_number'],
                'weights': obj_to_pickle_string(my_weights),
                'train_size': self.local_model.x_train[:int(2000*req['p2'])].shape[0],
